                       ...
                       children: [
                         const Padding(
                           ...
                           const Padding(
                             ...
                             child: Text(
                                                style: TextStyle(fontWeight: FontWeight.w400,fontSize: 16, color: Colors.white),
                                                "Kamu selesai kerja hari ini pukul 18:25 WIB.",textAlign: TextAlign.start,
                             ),
                           ),
                         const Spacer(),
                           Padding(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 10),
                                  child: SvgPicture.asset('assets/icons/tickcheck.svg'),
                                ),
                                const Expanded(child: Text("Berhasil check out kehadiran.", textAlign: TextAlign.start, style: TextStyle(fontSize: 11),))
                              ],
                            ),
                          ),
                        ),
